...
<head>
    ...
    <style>
        ...
        .sideBar a:hover {
            background-color: #29352b;     /* Màu nền khi hover (sẫm hơn một chút) */
            transform: scale(1.3);          /* Phóng to phần tử khi hover */
            border-color: #2980b9;         /* Đổi màu viền khi hover */
            box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2);  /* Thêm bóng đổ xung quanh phần tử khi hover */
        }
        .sideBar:active{
