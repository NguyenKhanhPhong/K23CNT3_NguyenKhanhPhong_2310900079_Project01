    ...
    <div class="container mx-auto">
      ...
      <div class="flex justify-between items-center py-2 text-sm">
        <div>
          ...
          <a class="mr-4 hover:underline" href="{{route('nkpuser.home')}}">Trang Chủ</a>
        ...
        <div>
          ...
          <a class="mr-4 hover:underline" href="nkp-user/support">
              <i class="fas fa-question-circle"></i> Hỗ Trợ
            </a>
          <a class="mr-4 hover:underline" href="#"><i class="fas fa-globe"></i> Tiếng Việt</a>
          <a class="mr-4 hover:underline" href="{{route('nkpuser.nkpsignup')}}">Đăng Ký</a>
          <a class="hover:underline" href="{{route('nkpuser.login')}}">Đăng Nhập</a>
        </div>
      </div>
      <!-- Main Navigation -->
      <div class="flex items-center py-4">
        <div class="flex items-center">
          <a href="{{route('nkpuser.home')}}"><img alt=" logo" class="mr-2" height="40" src="/storage/img/san_pham/logo.jpg" width="40"/></a>
          <span class="text-2xl font-bold">LapTopStore</span>
        </div>
        <div class="flex-grow mx-4">
          <form action="{{route('nkpuser.search')}}" method="GET" class="flex">
